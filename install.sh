...
curl "https://raw.github.com/dbcm/Unlock/master/files/name.ridgewell.unlock.plist" -o name.ridgewell.ulvh.plist
#cp ~/Work/Unlock/files/name.ridgewell.ulvh.plist .
curl "https://raw.github.com/dbcm/Unlock/master/files/name.ridgewell.unlock" -o ulvh
#cp ~/Work/Unlock/Xcode/build/Release/ulvh .
...
unlock() {
	...
	### TODO: check if password already added
